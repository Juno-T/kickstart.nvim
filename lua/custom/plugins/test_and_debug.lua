...
return {
  -- https://github.com/jay-babu/mason-nvim-dap.nvim
  {
    ...
    opts = {
      ...
      ensure_installed = {
        -- https://github.com/jay-babu/mason-nvim-dap.nvim/blob/main/lua/mason-nvim-dap/mappings/source.lua#L9
  ...
  },
  {
    ...
    dependencies = {
      ...
      -- virtual text for the debugger
      {
        ...
        opts = {
          -- virt_lines is experimental, may cause flickering.
          virt_lines = true,
        },
      },
    },
  ...
  keys = {
    ...
    config = function()
      ...
      for name, sign in pairs(lazyvim_config_icons_dap) do
