...
-- vim.keymap.set({ 'i' }, '', '<C-o>$', { desc = 'Cmd left, to back' })
vim.keymap.set({ 'i' }, '', '<C-\\><C-n>', { desc = 'Cmd left, exit insert mode into normal' })
vim.keymap.set({ 'i' }, '', '<C-\\><C-n>', { desc = 'Cmd left, exit insert mode into normal' })
vim.keymap.set({ 'n' }, '', '0', { desc = 'Cmd left, to front' })
vim.keymap.set({ 'n' }, '', '$', { desc = 'Cmd right, to back' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set(
        'n',
        '<leader>sb',
        ':Telescope file_browser respect_gitignore=false hidden=true grouped=true<CR>',
        { desc = '[S]earch Files with File [B]rowser' }
      )
      vim.keymap.set(
        'n',
        '<leader>sB',
        ':Telescope file_browser path=%:p:h select_buffer=true respect_gitignore=false hidden=true grouped=true<CR>',
        { desc = '[S]earch Files with Current File [B]rowser' }
      )
      ...
      end, { desc = '[S]earch in [.] current directory' })
      ...
      vim.keymap.set('n', '<leader>s/', require('telescope').extensions.egrepify.egrepify, { desc = '[S]earch project with egrepify [/]' })
  ...
  },
  {
    ...
    config = function()
      ...
      vim.list_extend(ensure_installed, {
        ...
        -- 'markdownlint', -- Used with kickstart.plugin.linter
      })
    ...
    opts = {
      ...
      custom_highlights = function(colors)
        return {
          ...
          ['@markup.quote'] = { fg = colors.flamingo, bg = colors.mantle },
          ['@markup.raw'] = { fg = colors.peach, bg = colors.mantle },
          RenderMarkdownCodeInline = { bg = colors.crust },
          RenderMarkdownCodeBorder = { fg = colors.subtext0 },
          rainbow1 = { fg = colors.mauve },
          rainbow2 = { fg = colors.blue },
          rainbow3 = { fg = colors.teal },
          rainbow4 = { fg = colors.green },
          rainbow5 = { fg = colors.yellow },
          rainbow6 = { fg = colors.peach },
          rainbow7 = { fg = colors.red },
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      --
      -- s is already mapped, so you need to be _quick_ when typing sa/sd/sr.
